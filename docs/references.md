...
| 2026-09-08 | this Treeland session `busctl` ScreenCast | Front `AvailableSourceTypes=3`, `AvailableCursorModes=0`, `version=1`; dde impl cursor `7` | [platform/wayland.md](platform/wayland.md) §Treeland smoke |
| 2026-09-08 | [xdg-desktop-portal ScreenCast](https://flatpak.github.io/xdg-desktop-portal/docs/doc-org.freedesktop.portal.ScreenCast.html) | `cursor_mode`; `streams` `a(ua{sv})` / `size (ii)`; unadvertised cursor closes the session | [platform/wayland.md](platform/wayland.md) §Treeland smoke |
| 2026-09-08 | `xdg-desktop-portal-dde` 1.1.9 | Impl `Start (oossa{sv}) → ua{sv}`; `ScreenCastChooser`; may not return until Allow | [platform/wayland.md](platform/wayland.md) §Treeland smoke |
| 2026-09-08 | [Qt `QDBusConnection::call` `QDBus::Block`](https://doc.qt.io/qt-6/qdbusconnection.html#call) | No GUI event loop; GUI freezes if `Start` waits on Allow | [platform/wayland.md](platform/wayland.md) §Treeland smoke item 1 |
| 2026-09-08 | [Qt `QDBusArgument`](https://doc.qt.io/qt-6/qdbusargument.html) | Nested struct in `a{sv}` as `QVariantMap`: `write from a read-only object`; libdbus type 114 (`r`) | [platform/wayland.md](platform/wayland.md) §Treeland smoke items 2, 5 |
| 2026-09-08 | [D-Bus re-entrancy](https://dbus.freedesktop.org/doc/dbus-specification.html#message-protocol-types) | Blocking `OpenPipeWireRemote` inside `Request.Response` deadlocks the portal | [platform/wayland.md](platform/wayland.md) §Treeland smoke item 3 |
| 2026-09-08 | `gstreamer1.0-pipewire` 1.6.4-1deepin19 | `gst-inspect-1.0 pipewiresrc` OK on this host | [platform/wayland.md](platform/wayland.md) §Treeland smoke |
| 2026-09-08 | this Treeland session Cast UI + `ot-cast.log` | After Allow: status “Select a screen to share…”, GUI frozen, no Pad P2P prompt, no `pipewiresrc` | [platform/wayland.md](platform/wayland.md) §Treeland smoke; [devices.md](devices.md) Xiaomi 2026-09-08 |
